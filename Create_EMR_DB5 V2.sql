...
CREATE TABLE `billing` (
 ...
 CREATE TABLE `receptionist_information` (
  `receptionist_id` int(11) PRIMARY KEY NOT NULL AUTO_INCREMENT,
  `receptionist_name` varchar(50) NOT NULL,
  `contact_number` varchar(50) DEFAULT NULL
  );
  
CREATE TABLE `supplier` (
  `supplier_id` varchar(50) PRIMARY KEY NOT NULL,
...
CREATE TABLE `patient_information_audit` (
  `patient_id` int(11) NOT NULL,
  `patient_first_name` varchar(50) NOT NULL,
  `patient_last_name` varchar(50) NOT NULL,
...
CREATE TABLE `medicine_audit` (
  ...
  `medicine_price_USD` decimal(10,2) NOT NULL,
  `supplier_id` varchar(50) NOT NULL,
  `action_type` varchar(50) NOT NULL,
  `action_by` varchar(50) NOT NULL,
  `action_date` datetime NOT NULL
